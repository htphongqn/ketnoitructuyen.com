...
namespace vpro.eshop.cpanel.Components
{
    public static class CpanelUtils
    {
        ...
        public static List<string[]> listAds()
        {
            ...
            { 
                new string[] { "0", "Slider" }, 
                new string[] { "1", "Ads top" },
                new string[] { "2", "Phải silder" },
                new string[] { "3", "Thương hiệu" },
                new string[] { "4", "Chuyên mục" },
                new string[] { "5", "Ads dưới" },
                new string[] { "6", "Ngân hàng" },
                new string[] { "10", "Khác" },
            };
            return l;
        }
        ...
        public static string ClearUnicodeSeo(string SourceString)
        {
