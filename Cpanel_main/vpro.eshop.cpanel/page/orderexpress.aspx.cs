...
namespace vpro.eshop.cpanel.page
{
    public partial class orderexpress : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ucHeader.HeaderLevel1 = "Đơn hàng nhanh";
                ucHeader.HeaderLevel1_Url = "../page/orderexpress.aspx";
                ucHeader.HeaderLevel2 = "Đơn hàng nhanh";
                ucHeader.HeaderLevel2_Url = "../page/orderexpress.aspx";
                Load_city();
                Load_distric(-1);
            }
        }
