<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="order_list.aspx.cs" Inherits="vpro.eshop.cpanel.page.order_list" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="icon_function_parent">
        ...
        <div class="icon_function_Child" runat="server">
            <asp:LinkButton ID="Lbprint" runat="server" CausesValidation="false" OnClick="Lbprint_Click"> <img src="../Images/print.png" width="30" height="30" style="border: 0px" /><div>
                    Print Excel</div></asp:LinkButton>
        </div>
    </div>
                    ...
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Địa chỉ" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                ...
                                <ItemTemplate>
                                    <%# getAddress(DataBinder.Eval(Container.DataItem, "ORDER_ADDRESS"),0)%>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow"></ItemStyle>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Quận/huyện" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="ORDER_ADDRESS">
                                <ItemTemplate>
                                    <%# getAddress(DataBinder.Eval(Container.DataItem, "ORDER_ADDRESS"),1)%>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow"></ItemStyle>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Tỉnh/thành phố" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="ORDER_ADDRESS">
                                <ItemTemplate>
                                    <%# getAddress(DataBinder.Eval(Container.DataItem, "ORDER_ADDRESS"),2)%>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow"></ItemStyle>
                            </asp:TemplateColumn>
                            ...
                            <asp:TemplateColumn HeaderText="Tổng tiền" HeaderStyle-Width="1%" ItemStyle-Wrap="true"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="ORDER_TOTAL_AMOUNT">
                                <ItemTemplate>
                                    <%# GetMoney(DataBinder.Eval(Container.DataItem, "ORDER_TOTAL_AMOUNT"))%>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%" HorizontalAlign="Left">
                                </HeaderStyle>
