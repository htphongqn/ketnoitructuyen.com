        ...
        <table width="auto" border="0">
            ...
            <tr>
                <th valign="top" class="left">
                    <span class="user">*</span>Chọn lần nhập kho
                </th>
                <td>
                    <asp:DropDownList ID="Drnhapkho" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="Drnhapkho_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtcode" runat="server" AutoPostBack="true" OnTextChanged="txtcode_TextChanged" Enabled="false"></asp:TextBox>
