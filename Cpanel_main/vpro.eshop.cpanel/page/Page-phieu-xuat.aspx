<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Page-phieu-xuat.aspx.cs" Inherits="vpro.eshop.cpanel.page.Page_phieu_xuat" %>
                    ...
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Đơn giá" HeaderStyle-Width="91%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtprice" runat="server" Text='<%#parelongMoney(Eval("BGD_PRICE")) %>'
