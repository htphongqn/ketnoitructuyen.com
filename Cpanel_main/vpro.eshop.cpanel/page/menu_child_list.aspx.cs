...
namespace vpro.eshop.cpanel.page
{
    public partial class menu_child_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ucHeader.HeaderLevel1 = "Left menu";
                ucHeader.HeaderLevel1_Url = "../page/menu_child_list.aspx";
                ucHeader.HeaderLevel2 = "Left menu";
                ucHeader.HeaderLevel2_Url = "../page/menu_child_list.aspx";
        ...
        private void EventDelete(DataGridCommandEventArgs e)
        {
            try
            {
                ...
                var g_delete = DB.GetTable<MENU>().Where(g => g.ID == NewsId);
        ...
        protected void lbtDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //delete 
                var g_delete = DB.GetTable<MENU>().Where(g => items.Contains(g.ID));
        ...
        protected void GridItemList_SortCommand(object source, DataGridSortCommandEventArgs e)
        {
            ...
            DataTable dataTable = Session["Leftmenu_child"] as DataTable;
        ...
        protected void GridItemList_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            ...
            GridItemList.DataSource = Session["Leftmenu_child"] as DataTable;
            GridItemList.DataBind();
        }
        protected void lbtSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtOrder = (HtmlInputText)itemgrid.Cells[4].FindControl("txtOrder");
                    
                    int CatId = Utils.CIntDef(GridItemList.DataKeys[i]);
                    var c_update = DB.GetTable<MENU>().Where(g => g.ID == CatId);

                    if (c_update.ToList().Count > 0)
                    {
                        c_update.Single().MENU_ORDER = Utils.CIntDef(txtOrder.Value);
                        DB.SubmitChanges();
                    }
