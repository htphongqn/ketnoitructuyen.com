...
namespace vpro.eshop.cpanel.page
{
    public partial class order_list : System.Web.UI.Page
    {
        ...
        protected void GridItemList_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            {
                e.Item.Cells[13].Attributes.Add("onClick", "return confirm('Bạn có chắc chắn xóa?');");
            }
        ...
        protected void Lbprint_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "Danh sách đơn hàng.xls"));
            Response.ContentType = "application/ms-excel";
            GridItemList.Columns[0].Visible = false;
            GridItemList.Columns[1].Visible = false;
            GridItemList.Columns[13].Visible = false;
