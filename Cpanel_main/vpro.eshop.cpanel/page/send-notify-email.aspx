<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="send-notify-email.aspx.cs" Inherits="vpro.eshop.cpanel.page.send_notify_email" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Gửi thông điệp | Vpro.Eshop</title>
    ...
    <div id="field">
        <table width="auto" border="0">
            ...
            <tr>
                ...
                <td colspan="2">
                    <input type="text" id="txttitle" style="width: 500px" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <textarea id="mrk" cols="20" rows="10" class="mrk" style="height: 500px; width: 500px"
