...
namespace vpro.eshop.cpanel.page
{
    public partial class xuat_kho : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ucHeader.HeaderLevel1 = "Xuất nhập kho";
                ucHeader.HeaderLevel1_Url = "../page/xuat-kho.aspx";
                ucHeader.HeaderLevel2 = "Xuất nhập kho";
                ucHeader.HeaderLevel2_Url = "../page/xuat-kho.aspx";
