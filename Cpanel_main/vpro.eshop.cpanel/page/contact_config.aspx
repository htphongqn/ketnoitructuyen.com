...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="field">
        ...
        <table width="auto" border="0">
            <tr>
                <td>
                    <textarea id="mrk2" cols="20" rows="10" class="mrk2" style="height: 500px;" runat="server"></textarea>
                </td>
            </tr>
        </table>
    </div>
     <div id="Div1">
        ...
        <table width="auto" border="0">
            <tr>
                <td>
                    <textarea id="mrk3" cols="20" rows="10" class="mrk3" style="height: 500px;" runat="server"></textarea>
                </td>
            </tr>
        </table>
    </div>
