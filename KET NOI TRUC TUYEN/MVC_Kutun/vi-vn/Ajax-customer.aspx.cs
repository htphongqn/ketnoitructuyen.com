...
namespace MVC_Kutun.vi_vn
{
    public partial class Ajax_customer : System.Web.UI.Page
    {
        ...
        static Product_Details prodetail = new Product_Details();
        #endregion
        ...
        public static string likepro(string seourl)
        {
            ...
            foreach (var i in list)
            {
                ...
                res += "       <a href='"+GetLink(i.NEWS_URL,i.NEWS_SEO_URL,1)+"'>";
        ...
        public static string GetLink(object News_Url, object News_Seo_Url, object cat_seo)
        {
            try
            {
