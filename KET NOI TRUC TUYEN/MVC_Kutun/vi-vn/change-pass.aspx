...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="path">
        <a href="/trang-chu.html">Trang chủ</a> » Đổi mật khẩu
    </div>
        ...
        <div class="box">
            ...
            <div class="list_products">
                <div class="profile-row">
                    ...
                    <p class="text input">
                        <asp:TextBox ID="txtpassOld" runat="server" CssClass="input-txt" Width="250" TextMode="Password"></asp:TextBox>
                ...
                <div class="profile-row">
                    ...
                    <p class="text input">
                        <asp:TextBox ID="txtpassNew" runat="server" CssClass="input-txt" Width="250" TextMode="Password"></asp:TextBox>
                ...
                <div class="profile-row">
                    ...
                    <p class="text input">
                        <asp:TextBox ID="txtrepass" runat="server" CssClass="input-txt" Width="250" TextMode="Password"></asp:TextBox>
