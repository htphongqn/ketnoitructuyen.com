    ...
    public partial class Payment_step3 : System.Web.UI.Page
    {
        ...
        private void Finish(int _hinhthucpay)
        {
            try
            {
                ...
                string _sDesc = Utils.CStrDef(Request["note"])+" "+txthd.Value;
        ...
        {
            Finish(2);
            Response.Redirect("/finish.aspx?orderid="+Payment_cart._idorder);
        }
