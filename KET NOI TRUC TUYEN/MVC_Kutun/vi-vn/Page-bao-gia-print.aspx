<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page-bao-gia-print.aspx.cs"
    Inherits="MVC_Kutun.vi_vn.Page_bao_gia_print" %>
    ...
    <div>
        <div class="page_print">
            <table width="100%">
                <tr>
                    <td width="25%" align="center">
                        <asp:Image ID="Imglogo" runat="server" Width="200px" Height="80px" />
                    </td>
                    <td width="70%">
                        <table width="100%" border="0" style="font-size: 12px; font-weight: 500">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <td>
                                        <a href="www.ketnoitructuyen.com" style="color: #FF0000">www.ketnoitructuyen.com</a>
                                    </td>
                            </tr>
                        </table>
                    </td>
            ...
            <div class="info_head" style="width: 100%; float: left; position: relative">
                <img src="../vi-vn/Images/hinhnen.png" style="width: 100%; height: 92px; position: absolute" />
                <div style="float: left; width: 48%; height: 75px; padding-top: 15px">
                    Kính gửi:
                ...
                <div style="float: left; width: 12%; height: 75px;">
                </div>
                <div style="float: left; width: 40%; height: 75px; padding-top: 15px">
                    Báo giá số:
            ...
            <div class="content_banggia cf">
                ...
                <table class="MsoNormalTable" border="1" cellspacing="0" cellpadding="5" width="100%"
                    ...
                    <tr style="height: 2.5pt">
                        ...
                        <td width="125" style="border-right: 1.0pt solid windowtext; border-top: 1.0pt solid windowtext;
                            ...
                            <p class="MsoNormal" align="center" style="text-align: center; font-size: 12px;">
                                <b><span class="style2">Nhà Sản Xuất
                                    <o:p></o:p>
                                </span></b>
                            </p>
                        </td>
                    ...
                    <asp:Repeater ID="Rpprobaogia" runat="server">
                        <ItemTemplate>
                            <tr style="height: 15.6pt">
                                ...
                                <td align="right">
                                    <%# FormatMoney(Eval("BASKET_PRICE"))%>
                                </td>
                                <td align="center">
                                    0
                                </td>
                                <td align="right">
                                    <%# getAmount(Eval("BASKET_PRICE"), Eval("BASKET_QUANTITY"), 0)%>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                ...
                <p class="MsoBodyText3" align="left" style="text-align: left; font-family: Arial, Helvetica, sans-serif;
                    font-size: 12px;">
                    <o:p> &nbsp;</o:p>
                </p>
