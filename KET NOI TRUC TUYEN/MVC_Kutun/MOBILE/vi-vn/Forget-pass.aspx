...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="box" id="account">
        <div class="box_Tab">
            Quên mật khẩu</div>
        <span class="form_subtitle">Lấy lại mật khẩu</span>
        <!--Form Login-->
        <div class="box_ct login_form form_web">
            <div class="row_account">
                <label for="formUsername" class="item_title">
                    Email:<span class="required">*<asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                        runat="server" ErrorMessage="Chưa nhập Email" ControlToValidate="txtemail" Display="Dynamic"
                        ForeColor="Red" ValidationGroup="G7" CssClass="tlp-error">*</asp:RequiredFieldValidator></span></label>
            ...
            <div class="row_account">
                <label for="formUsername" class="item_title">
                    Mã bảo vệ:<span class="required">*<asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                        runat="server" ErrorMessage="Chưa nhập mã bảo mật" ControlToValidate="Textcapchaforget"
                        Display="Dynamic" ForeColor="Red" ValidationGroup="G7">*</asp:RequiredFieldValidator></span></label>
            ...
            <div class="row_account text">
                <asp:LinkButton ID="Lbforget" runat="server" class="btn_web button1" OnClick="Lbforget_Click"
