    ...
    public partial class Payment_giaohangtannoi : System.Web.UI.UserControl
    {
        ...
        protected void lbnext_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(email))
                email = "no-reply@ketnoitructuyen.com";
            ...
            Response.Redirect("/thanh-toan-buoc-3-mobile.aspx?typepay=1&name=" + name + "&phone=" + phone + "&email=" + email + "&add=" + add + "&date=" + date + "&note=" + remark + "");
        }
