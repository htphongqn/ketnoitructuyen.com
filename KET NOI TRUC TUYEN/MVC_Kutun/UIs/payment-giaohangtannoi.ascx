...
<script src="../vi-vn/Ajax/Checkvalid.js" type="text/javascript"></script>
<form>
<div class="row_account">
    ...
    <div class="right_row_account fr">
        <input class="txtpassdangnhap" type="text" name="formFullname" id="Txtname" placeholder="Tên đầy đủ của bạn"
            runat="server" clientidmode="Static" />
    </div>
</div>
<div class="row_account">
    <label class="item_title" for="formPhone">
        Điện thoại liên lạc:<span class="required">*
    ...
    <div class="right_row_account fr">
        <input class="txtpassdangnhap" type="text" name="formPhone" id="txtphone" placeholder="Ví dụ: 0909123456"
            runat="server" />
    </div>
</div>
<div class="row_account">
    <label class="item_title" for="formEmail">
        Email liên lạc:<span class="required">*
    ...
    <div class="right_row_account fr">
        <input class="txtpassdangnhap" type="text" name="formEmail" id="txtemail" placeholder="Ví dụ: name@gmail.com"
            runat="server" />
    </div>
</div>
<div class="row_account">
    <label class="item_title" for="formAddress">
        Địa chỉ:<span class="required">*<asp:RequiredFieldValidator ID="RequiredFieldValidator3"
            runat="server" ErrorMessage="Vui lòng nhập địa chỉ" ControlToValidate="txtadd" Display="Dynamic"
            ForeColor="Red" ValidationGroup="G40">*</asp:RequiredFieldValidator></span></label>
    <div class="right_row_account fr">
        <input class="txtpassdangnhap" type="text" name="formAddress" id="txtadd" placeholder="Số nhà,đường,(tòa nhà),phường xã ..."
            runat="server" />
    </div>
</div>
<div class="row_account">
    <label class="item_title" for="formCountry">
        Tỉnh/TP:<span class="required">*<asp:RequiredFieldValidator ID="RequiredFieldValidator5"
            runat="server" ErrorMessage="Vui lòng chọn tỉnh/thành phố" ControlToValidate="Drcity" Display="Dynamic"
            ForeColor="Red" ValidationGroup="G40" InitialValue="0">*</asp:RequiredFieldValidator></span></label>
    <div class="right_row_account fr">
...
<div class="row_account">
    <label class="item_title" for="formDistrict">
        Quận/Huyện:<span class="required">*<asp:RequiredFieldValidator ID="RequiredFieldValidator2"
            runat="server" ErrorMessage="Vui lòng chọn quận/huyện" ControlToValidate="Drdistric" Display="Dynamic"
            ForeColor="Red" ValidationGroup="G40" InitialValue="0">*</asp:RequiredFieldValidator></span></label>
    <div class="right_row_account fr">
...
<div class="row_account">
    <label class="item_title" for="formDate">
        Thời gian giao:<span class="required">*</span></label>
    <div class="right_row_account fr">
...
<div class="row_account">
    <label class="item_title" for="formMessage">
        Lời nhắn:</label>
    <div class="right_row_account fr">
        <textarea placeholder="Vui lòng điền thông tin kích thước, thời gian …… để chúng tôi phục vụ tốt hơn"
