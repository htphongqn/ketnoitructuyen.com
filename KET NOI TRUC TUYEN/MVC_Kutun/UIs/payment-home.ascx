...
<div class="row_account">
    <label class="item_title" for="formFullname">
        Họ tên:<span class="required">*<asp:RequiredFieldValidator ID="RequiredFieldValidator2"
            runat="server" ErrorMessage="Chưa nhập tên" ControlToValidate="txtname" Display="Dynamic"
            ForeColor="Red" ValidationGroup="G50">*</asp:RequiredFieldValidator></span></label>
...
<div class="row_account">
    <label class="item_title" for="formEmail">
        Email liên lạc:<span class="required">*<asp:RequiredFieldValidator ID="RequiredFieldValidator3"
            runat="server" ErrorMessage="Vui lòng nhập email" ControlToValidate="txtemail" Display="Dynamic"
            ForeColor="Red" ValidationGroup="G50">*</asp:RequiredFieldValidator></span></label>
    <div class="right_row_account fr">
...
<div class="row_account">
    <label class="item_title" for="formPhone">
        Điện thoại liên lạc:<span class="required">*<asp:RequiredFieldValidator ID="RequiredFieldValidator1"
            runat="server" ErrorMessage="Chưa nhập số điện thoại" ControlToValidate="txtphone"
            Display="Dynamic" ForeColor="Red" ValidationGroup="G50">*</asp:RequiredFieldValidator></span></label>
    <div class="right_row_account fr">
